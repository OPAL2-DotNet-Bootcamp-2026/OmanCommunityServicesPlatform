...
export default tseslint.config(
  {
    // scripts/ holds the legacy IIFE JavaScript that is being migrated file by
    // file. It is deliberately not linted; the directory disappears once the
    // last module has been converted.
